...
import type { TypegenConstraint, TypegenDisabled, ResolveTypegenMeta } from "./typegenTypes"
 ...
 */
export function Machine<TContext = any, TEvent extends EventObject = AnyEventObject>(
...
>(
  ...
  return new StateNode<TContext, TStateSchema, TEvent>(config, options, initialContext) as any
}
...
>(
  config: MachineConfig<TContext, any, TEvent, BaseActionObject, TServiceMap, TTypesMeta>,
  options?: MachineOptions<TContext, TEvent, BaseActionObject, TServiceMap, TTypesMeta>
): StateMachine<TContext, any, TEvent, TTypestate, BaseActionObject, TServiceMap, TTypesMeta> {
