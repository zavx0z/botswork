import type { AtomicStateNodeConfig, StatesConfig, Event, EventObject, StateSchema, StateNodeConfig } from "./types"
...
export function sequence<TStateSchema extends StateSchema, TEvent extends EventObject>(
  ...
  const nextEventObject = resolvedOptions.nextEvent === undefined ? undefined : toEventObject(resolvedOptions.nextEvent)
  const prevEventObject = resolvedOptions.prevEvent === undefined ? undefined : toEventObject(resolvedOptions.prevEvent)
