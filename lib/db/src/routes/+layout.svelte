...
<div class="flex min-h-screen flex-col">
  <header class="flex items-center justify-between bg-indigo-600 px-2 py-1">
    <div>
      <span class="text-2xl font-semibold text-white">SvelteKit Offline</span>
    </div>
    <div>
      <button class="flex h-8 w-8 items-center rounded-md p-1 text-white hover:text-indigo-200 focus:outline-none focus:ring-1 focus:ring-pink-300" on:click={() => (isOpen = true)}
