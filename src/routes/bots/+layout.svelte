...
{#if $sideBarRight.matches('opened')}
	<nav
		class="fixed inset-y-0 right-0 flex-row z-{$sideBarLeft.context
			.zIndex} flex h-full w-12 flex-col items-center justify-between justify-items-center bg-surface-900"
	/>
	<div
