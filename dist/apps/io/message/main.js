...
// ========================================= PROJECT ENV =============================================
const channel = channels_1.Io.MESSAGE;
const PORT = process.env.IO_MESSAGE_PORT;
// ========================================= CONNECTIONS =============================================
...
io.on('connection', (socket) => {
    ...
    (0, channels_1.redirect)({ to: channels_1.Io.CHAT, socket, redis: pubClient });
...
// ============================================ RUN ====================================================
(0, channels_1.receive)({ channel, redis: subClient, handler });
