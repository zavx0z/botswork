<script lang="ts">
  ...
  import { ButtonCallScreenShare } from "@lib/ui/button"
...
<form
  method="post"
  class="p-4 flex flex-col gap-4 w-1/2"
...
>
  ...
  <button type="submit" class="bg-blue-300 p-2 rounded-md"> Отправить сообщение </button>
</form>
